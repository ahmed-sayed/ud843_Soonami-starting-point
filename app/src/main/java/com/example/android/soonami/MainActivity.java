...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                //  any thing before " urlConnection.connect " LINE is about
                ...
                urlConnection.connect(); // opens a communication link
                                        // to the resource referenced by the URL

                // everything after  " urlConnection.connect " LINE is about
